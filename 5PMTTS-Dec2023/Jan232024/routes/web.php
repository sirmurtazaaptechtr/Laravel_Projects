...
Route::get('/updateform/id/{id?}',[StudentController::class,'updateForm'])->name('updateForm');
Route::post('/student/updateform/{id?}/updatestudent',[StudentController::class,'updateStudent'])->name('updateStudent');